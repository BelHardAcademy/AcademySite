<form id="redactorForm" action="">
    ...
    <script>
          ...
          success: function (data) { 
            ...
            $(data).each(function(index){
              ...
              $(data[index].links).each(function(indexPicture) {
                ...
                $(newGalleryHeaderBlock).attr("id", data[index]["_id"]);
                $(newGalleryFooterBlock).attr("id", data[index]["_id"]);
      ...
      $("#listGalleriesHeader").on("change", function(){
        ...
        $("div #" + galleryId).siblings().css("display", "none");
      });

      $("#listGalleriesFooter").on("click", function(){
  ...
  <script>
   ...
   $(".closeBtn").on("click", function() {
    $(this).parent("td .templatePagesBlock").empty();
   });
 </script>